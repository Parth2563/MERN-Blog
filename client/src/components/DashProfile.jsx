...
import {updateStart, updateSuccess, updateFailure, deteleUserStart, deteleUserSuccess, deteleUserFailure, signoutSuccess} from '../redux/user/userSlice';
...
export default function DashProfile() {
    ...
    const handleDeleteUser = async () => {
        ...
        try {
            ...
            dispatch(deteleUserFailure(error.message));
        }
    }
